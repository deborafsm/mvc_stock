...
--
-- Table structure for table `monitordef`
--

DROP TABLE IF EXISTS `monitordef`;
...
--
-- Dumping data for table `monitordef`
--

LOCK TABLES `monitordef` WRITE;
/*!40000 ALTER TABLE `monitordef` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitordef` ENABLE KEYS */;
UNLOCK TABLES;
