...
--
-- Table structure for table `defeitopc`
--

DROP TABLE IF EXISTS `defeitopc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `defeitopc` (
  `id_pcDef` int(11) NOT NULL AUTO_INCREMENT,
  `datadef` varchar(500) DEFAULT NULL,
...
--
-- Dumping data for table `defeitopc`
--

LOCK TABLES `defeitopc` WRITE;
/*!40000 ALTER TABLE `defeitopc` DISABLE KEYS */;
/*!40000 ALTER TABLE `defeitopc` ENABLE KEYS */;
UNLOCK TABLES;
